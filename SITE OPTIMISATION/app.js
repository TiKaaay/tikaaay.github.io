...
window.addEventListener("load", () => {
    ...
    TimeLine.from(header, 0.5, {opacity: 0} )
    TimeLine.from(filante, 0.5, {left: -600}, 0.7, "-=1")
    TimeLine.staggerFrom(nav, 0.5, {top: -70},0.5, "-=1")
    TimeLine.staggerFrom(returnUp, 1, {opacity: 0}, 0.5, "-=1")
